...
const parameters = [
  {
    ...
    required: 'Required',
    type: 'string',
    value: 'The reason for which you request the communication items to be unsubscribed',
  },
  {
    id: 2,
...
curl --location 'https://capi.mesergo.co.il/api/V2/Contact/Unsubscribe' \
...
const whitelistResponse = `
{
  ...
  "DetailedDescription": "",
  "FunctionName": "api/V2/Contact/Unsubscribe",
  "RequestId": ",,Abh5mclRnbp5Sdy9mZulmLkV3bsNWPl1WYOR3cvhkJzATQzUyM0E0MlATMrEDMtYDMtEjMwITPw1WY0NVZtlGVmQDNyQDNwETPklkclNXV",
  "Data": {
    "Success": {
      "Count": 1
    },
...
const whitelistHeaders = [
  { key: 'Date', value: 'Tue, 01 Jun 2021 07:43:03 GMT' },
  { key: 'Server', value: 'Apache' },
  { key: 'Content-Length', value: '420' },
  { key: 'Keep-Alive', value: 'timeout=5, max=100' },
  { key: 'Connection', value: 'Keep-Alive' },
  { key: 'Content-Type', value: 'application/json; charset=utf-8' }
];

const whitelistlink = `https://capi.mesergo.co.il/api/V2/Contact/Unsubscribe`;
const advancedLink = `https://capi.mesergo.co.il/api/v2/Contact/Unsubscribe?view=json`;
...
<template>
  <div class="xl:flex rounded-md space-x-10 border-b border-gray-300">
    ...
    <div class="xl:w-[50%]">
      <div class="mb-6 mt-5 border-b border-gray-300 pb-4">
        <div class="flex items-center gap-2 mb-2">
          ...
          <h1 class=" font-semibold text-gray-900">Unsubscribe</h1>
        </div>
        <Murkdown :rawCode="whitelistlink" />
        <p class="mt-3 test-sm">This function unsubscribes Phones and Emails.</p>
        <p class="mt-3 test-sm">You may send up to 100 communication items per request.</p>
    ...
    <div class="xl:w-[50%] bg-[#272822] h-auto rounded-md">
      <DocCode class="mt-[-.5rem]" title="Example Request" subtitle="Unsubscribe" language="json"
