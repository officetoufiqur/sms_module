...
const parameters = [
  {
    id: 1,
    parameters: 'UnsubscribeReason',
    required: 'Required',
    type: 'string',
    value: '– The reason for which you wish to reactivate the unsubscribed',
  },
  {
    id: 2,
    parameters: 'UnsubscribeName',
    required: 'Optional',
    type: 'string',
    value: 'The system name which executes the request (optional - default API).',
  },
  {
    id: 3,
    parameters: 'Type',
...
{
    "Data": {
        "ReactivationReason": "Customer request",
        "List": [
            {
                "Type": "Phone",
                "Value": "0541234567"
...
curl --location 'https://capi.mesergo.co.il/api/v2/Contact/ReactivateUnsubscribe' \
...
const whitelistResponse = `
{
  ...
  "DetailedDescription": "",
  "FunctionName": "api/v2/Contact/ReactivateUnsubscribe",
  "RequestId": ",,Abh5mclRnbp5Sdy9mZulmLkV3bsNWPl1WYOR3cvhkJ3ITQzUSOyE0MlQTMrEDMtYDMtEjMwITPw1WY0NVZtlGVmQDNyQDNwETPklkclNXV",
  "Data": {
    "Success": {
      "Count": 1
    },
...
const whitelistHeaders = [
  { key: 'Date', value: 'Tue, 01 Jun 2021 11:29:26 GMT' },
  { key: 'Server', value: 'Apache' },
  { key: 'Content-Length', value: '430' },
  { key: 'Keep-Alive', value: 'timeout=5, max=100' },
  { key: 'Connection', value: 'Keep-Alive' },
  { key: 'Content-Type', value: 'application/json; charset=utf-8' }
];

const whitelistlink = `https://capi.mesergo.co.il/api/v2/Contact/ReactivateUnsubscribe`;
const advancedLink = `https://capi.mesergo.co.il/api/v2/Contact/ReactivateUnsubscribe?view=json`;
...
<template>
  <div class="xl:flex rounded-md space-x-10 border-b border-gray-300">
    ...
    <div class="xl:w-[50%]">
      <div class="mb-6 mt-5 border-b border-gray-300 pb-4">
        <div class="flex items-center gap-2 mb-2">
          ...
          <h1 class=" font-semibold text-gray-900">Reactivate Unsubscribe</h1>
        </div>
        <Murkdown :rawCode="whitelistlink" />
        <p class="mt-3 test-sm">This function reactivates unsubscribed items.</p>
        <p class="mt-3 test-sm">You may send up to 100 items (Phones or Emails) per request.</p>
      ...
      <p class="mt-3 font-medium">Advanced options</p>
    ...
    <div class="xl:w-[50%] bg-[#272822] h-auto rounded-md">
      <DocCode class="mt-[-.5rem]" title="Example Request" subtitle="Reactivate Unsubscribe" language="json"
